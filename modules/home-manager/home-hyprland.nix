...
wayland.windowManager.hyprland = {
  ...
  settings = {
    ...
    bind = [
      ...
      "$mod, V, exec, pkill wofi || cliphist list | wofi -S dmenu | cliphist decode | wl-copy && sleep 0.1 && ydotool key 29:1; ydotool key 47:1; ydotool key 47:0; ydotool key 29:0"
